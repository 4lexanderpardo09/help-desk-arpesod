...
--
-- Host: mesadeayuda.electrocreditosdelcauca.com    Database: electroc_mesaayuda
-- ------------------------------------------------------
...
) ENGINE=InnoDB AUTO_INCREMENT=292 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tm_ticket` (
  ...
  `est` int NOT NULL,
  PRIMARY KEY (`tick_id`)
) ENGINE=InnoDB AUTO_INCREMENT=199 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `tm_usuario` (
  ...
  `est` int NOT NULL,
  PRIMARY KEY (`usu_id`)
) ENGINE=InnoDB AUTO_INCREMENT=21 DEFAULT CHARSET=utf8mb3 COLLATE=utf8mb3_spanish_ci COMMENT='Tabla Mantenedor de Usuarios';
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping routines for database 'electroc_mesaayuda'
--
...
DELIMITER ;;
CREATE DEFINER=`root`@`mesadeayuda.electrocreditosdelcauca.com` PROCEDURE `sp_d_usuario_01`(IN `xusu_id` INT)
BEGIN
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`mesadeayuda.electrocreditosdelcauca.com` PROCEDURE `sp_l_usuario_01`()
BEGIN
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`mesadeayuda.electrocreditosdelcauca.com` PROCEDURE `sp_l_usuario_02`(IN `xusu_id` INT)
BEGIN
...
/*!50003 SET sql_mode              = 'IGNORE_SPACE,ONLY_FULL_GROUP_BY,STRICT_TRANS_TABLES,NO_ZERO_IN_DATE,NO_ZERO_DATE,ERROR_FOR_DIVISION_BY_ZERO,NO_ENGINE_SUBSTITUTION' */ ;
DELIMITER ;;
CREATE DEFINER=`root`@`mesadeayuda.electrocreditosdelcauca.com` PROCEDURE `sp_reporte`()
BEGIN
        SELECT
...
-- Dump completed on 2025-06-11  8:13:42
